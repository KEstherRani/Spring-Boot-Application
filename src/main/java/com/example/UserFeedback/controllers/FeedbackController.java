...
public class FeedbackController {
    ...
    public String showIndexPage(ModelMap model){   
		 return "<html>\n"
				...
				+"           <table align=\"center\">"
				+ "			<tr><td><input type=\"text\" id=\"comment\" name=\"comment\" placeholder=\"Comment Here\" required></td></tr>\n"
				+ "			<tr><td><input type=\"number\" id=\"rating\" name=\"rating\" placeholder=\"Rating Here\" required></td></tr>\n"
				+ "			<tr><td><input type=\"text\" id=\"name\" name=\"name\" placeholder=\"Name Here\" required></td></tr>	\n"
